""" Programa 3
    ...
    Fecha: 24/01/2023
    Descripcion:En este programa observamos como funciona la funcion format de diferentes          maneras con operaciones aritmeticas"""
...
print("suma = {} + {} = {}".format(variable1,variable2,variable1+variable2))  #  Imprime con la funcion format las variables y realiza la suma de estas 2 variables mostrando el resultado
